...
@section('content')
    <fieldset id="category" class="layui-elem-field layui-field-title sys-list-field" >
        <legend style="text-align:center;">回收资源列表</legend>
        <div class="layui-field-box">
            <!--内容区域 ajax获取-->
            <table style="" class="layui-table" lay-even="">
                ...
                @foreach($recycling as $key=> $rec)
                    <tr>
                        ...
                        <td>
                            <a id = 'editArticle' onclick="restore(this,'mogo_resource',  {{$rec->id}} )">
                                <button  class="layui-btn layui-btn-small layui-btn-normal">
                                    还原
                                </button> </a>
                        </td>
                        <td>
                            <button onclick="cate_del(this,'{{$rec->id}}')" class="layui-btn layui-btn-small layui-btn-danger">
                                删除
                            </button>
                        </td>
                    </tr>
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        {{--{{$specs->links()}}--}}
                        {!! $recycling->appends($request->only(['keyword']))->render() !!}
                    </div>
                </div>
            </div>
        </div>
