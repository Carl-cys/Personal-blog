            ...
            <div id="articleIndexTop">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item" style="margin:0;margin-top:15px;">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width:auto">
                                <a id="addfig" style="text-decoration: none;" href="{{url('/admin/figure/create')}}" class="layui-btn layui-btn-normal">添加格言图片</a>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('content')
    <fieldset id="category" class="layui-elem-field layui-field-title sys-list-field" >
        <legend style="text-align:center;">格言与背景列表</legend>
        <div class="layui-field-box">
            <!--内容区域 ajax获取-->
            <table style="" class="layui-table" lay-even="">
                ...
                <tr>
                    ...
                    <th style="width: 500px">格言</th>
                    <th style="width: 300px">url</th>
                    <th style="width: 500px">图片</th>
                    <th colspan="2">操作</th>
                </tr>
                </thead>
                <tbody>

                @foreach($figure as $key=> $fig)
                    <tr>
                        <td>{{$fig->id}}</td>
                        ...
                        <td><img style="height: 150px;width: 350px;" src = '{!! $fig->img!!}'></td>


                        <td>
                            <a id = 'editFig' href="{{url('/admin/figure/'.$fig->id.'/edit')}}">
                        ...
                        <td>
                            ...
                            <button onclick="cate_del(this,'{{$fig->id}}')" class="layui-btn layui-btn-small layui-btn-danger"><i class="layui-icon">&#xe640;</i>
                            </button>
                            {{--</a>--}}
                        </td>
                    </tr>
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        {{--{{$specs->links()}}--}}
                        {!! $figure->appends($request->only(['keyword']))->render() !!}
                    </div>
                </div>
            </div>
        </div>
