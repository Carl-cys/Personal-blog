            ...
            <div id="articleIndexTop">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item" style="margin:0;margin-top:15px;">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width:auto">
                                <a id="addNav" style="text-decoration: none;" href="{{url('/admin/resource/create')}}" class="layui-btn layui-btn-normal">添加资源</a>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('content')
    <fieldset id="category" class="layui-elem-field layui-field-title sys-list-field" >
        <legend style="text-align:center;">资源列表</legend>
        <div class="layui-field-box">
            <!--内容区域 ajax获取-->
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: center; width: 50px;">
                                 <span class="@if($res->is_display == '0') no @else yes @endif"   onclick="changeTableVal('is_display' , 'mogo_resource', '{{$res->id}}' ,'{{url('/admin/getAjaxMod')}}',this)">
                                 @if($res->is_display == '0')<i class=" Wrong">✘</i>否 @else  <i class="fanyes">✔</i>是 @endif
                                 </span>
                            </div>
                        </td>

                        <td>
                            <a id = 'editResource' href="{{url('/admin/resource/'.$res->id.'/edit')}}">
                        ...
                        <td>
                            ...
                            <button onclick="cate_del(this,'{{$res->id}}')" class="layui-btn layui-btn-small layui-btn-danger"><i class="layui-icon">&#xe640;</i>
                            </button>
                            {{--</a>--}}
                        </td>
                    </tr>
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        {{--{{$specs->links()}}--}}
                        {!! $resource->appends($request->only(['keyword']))->render() !!}
                    </div>
                </div>
            </div>
        </div>
