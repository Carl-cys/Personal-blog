        ...
        <form class="layui-form " action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" value="{{$user->nickname}}" name="nickname" required="" lay-verify="nikename" placeholder="请输入名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-form-mid layui-word-aux">默认不修改</div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">邮箱</label>
                <div class="layui-input-block">
                    <input type="email" value="{{$user->email}}" name="email" required="" lay-verify="email" placeholder="请输入邮箱" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" style="position:relative;">
                ...
                <div class="layui-input-inline">
                    ...
                    <img id="articleCoverImg" class="img-cover"
                         ...
                         @endif
                         style='border: 1px solid #ddd; margin-left:30px' width="200" alt="封面">                </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-filter="formEditUser" lay-submit>立即发布</button>
