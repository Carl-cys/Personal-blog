            ...
            <div id="articleIndexTop">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item" style="margin:0;margin-top:15px;">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width:auto">
                                <a id="addNot" style="text-decoration: none;" href="{{url('/admin/user/create')}}" class="layui-btn layui-btn-normal">添加管理员</a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <table style="" class="layui-table" lay-even="">
                ...
                @foreach($users as $key=> $user)
                    <tr>
                        ...
                        <td><img src="{{ $user->pic}}" width="200"></td>

                        <td>
                            <a id = 'editUser' href="{{url('/admin/user/'.$user->id.'/edit')}}">
                        ...
                        <td>
                            ...
                            <button onclick="cate_del(this,'{{$user->id}}')" class="layui-btn layui-btn-small layui-btn-danger"><i class="layui-icon">&#xe640;</i>
                            </button>
                            {{--</a>--}}
                        </td>
                    </tr>
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        {{--{{$specs->links()}}--}}
                        {!! $users->appends($request->only(['keyword']))->render() !!}
                    </div>
                </div>
            </div>
        </div>
