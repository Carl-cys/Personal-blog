        ...
        <form class="layui-form " action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input  value="{{$timeline->title}}" type="text" name="title" required="" lay-verify="required" placeholder="请输入标题名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-field-box">
                ...
                <div class="layui-input-block" >
                    <textarea id="editor" name="content" style="z-index:0;height:500px;" type="text/plain">{{$timeline->content}}</textarea>
                    <script >
                        //实例化编辑器
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-filter="formEditTimeline" lay-submit>立即发布</button>
...
@section('js')
    <script>
        layui.use(['form','layer','upload'], function(){
            ...
            form.on('submit(formEditTimeline)', function(data){
                var index = layer.load(2);
                $.ajax({
                    type: 'post',
                    url:  "/admin/timeline/"+data.field.id,
                    dataType: 'json',
