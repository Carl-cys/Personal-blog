            ...
            <div id="articleIndexTop">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item" style="margin:0;margin-top:15px;">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width:auto">
                                <a id="addNav" style="text-decoration: none;" href="{{url('/admin/timeline/create')}}" class="layui-btn layui-btn-normal">添加时光轴</a>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('content')
    <fieldset id="category" class="layui-elem-field layui-field-title sys-list-field" >
        <legend style="text-align:center;">时光列表</legend>
        <div class="layui-field-box">
            <!--内容区域 ajax获取-->
            <table style="" class="layui-table" lay-even="">
                ...
                @foreach($timeline as $key=> $res)
                    <tr>
                        ...
                        <td>
                            <a id = 'editTimeline' href="{{url('/admin/timeline/'.$res->id.'/edit')}}">
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        {{--{{$specs->links()}}--}}
                        {!! $timeline->appends($request->only(['keyword']))->render() !!}
                    </div>
                </div>
            </div>
        </div>
