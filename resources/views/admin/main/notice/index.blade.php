            ...
            <div id="articleIndexTop">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item" style="margin:0;margin-top:15px;">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width:auto">
                                <a id="addNot" style="text-decoration: none;" href="{{url('/admin/notice/create')}}" class="layui-btn layui-btn-normal">添加公告</a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <table style="" class="layui-table" lay-even="">
                ...
                @foreach($notice as $key=> $not)
                    <tr>
                        ...
                        <td>
                            <a id = 'editTNotice' href="{{url('/admin/notice/'.$not->id.'/edit')}}">
                        ...
                        <td>
                            ...
                            <button onclick="cate_del(this,'{{$not->id}}')" class="layui-btn layui-btn-small layui-btn-danger"><i class="layui-icon">&#xe640;</i>
                            </button>
                            {{--</a>--}}
                        </td>
                    </tr>
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        {{--{{$specs->links()}}--}}
                        {!! $notice->appends($request->only(['keyword']))->render() !!}
                    </div>
                </div>
            </div>
        </div>
