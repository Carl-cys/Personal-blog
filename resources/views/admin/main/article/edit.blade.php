            ...
            <form class="layui-form " action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="{{$articleinfo->title}}" name="title" required="" lay-verify="required" placeholder="请输入标题名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="cate_id" lay-filter="aihao" lay-verify="required">
                            ...
                            @foreach($cates as $cate)
                                <option value="{{$cate->id}}" @if( $articleinfo->cate_id == $cate->id ) selected @endif>{{$cate->cate_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="{{$articleinfo->abstract}}" name="abstract" required="" lay-verify="required" placeholder="请输入摘要" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item" style="position:relative;">
                    ...
                    <div class="layui-input-inline">
                        <input id="articleCoverSrc" name="img" value="{{$articleinfo->img}}" type="hidden">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" @if($articleinfo->read_top == '1') checked @endif name="read_top" title="置顶">
                        <input type="checkbox"  @if($articleinfo->read_ecommend == '1') checked @endif name="read_ecommend" title="推荐">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" >
                        <textarea id="editor" name="content" style="z-index:0;height:500px;" type="text/plain">
                            {{$articleinfo->content}}
                        </textarea>
                        <script >
                            //实例化编辑器
